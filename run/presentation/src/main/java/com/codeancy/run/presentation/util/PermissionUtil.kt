package com.codeancy.run.presentation.util
...
fun ComponentActivity.shouldShowNotificationPermissionRationale(): Boolean {
    return Build.VERSION.SDK_INT >= 33 && shouldShowRequestPermissionRationale(
...
fun Context.hasNotificationPermission(): Boolean =
    if (Build.VERSION.SDK_INT >= 33) hasPermission(Manifest.permission.POST_NOTIFICATIONS) else true